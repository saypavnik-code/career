...
export interface RetrievalMatch { criterion: Record<string, unknown>; overlap: number; explicit: boolean }
export interface Retrieval { knowledgeBaseVersion: string; currentLevel: string; targetLevel: string | null; competencyIds: string[]; criteria: Array<Record<string, unknown>>; matches: RetrievalMatch[] }
